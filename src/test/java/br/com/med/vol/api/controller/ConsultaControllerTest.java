...
import br.com.med.vol.api.domain.consulta.AgendaDeConsultas;
...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 400 qunado informações estão invalidas")
    @WithMockUser
    ...
    @Test
    @DisplayName("Deveria devolver codigo http 200 qunado informações estão validas")
    @WithMockUser
